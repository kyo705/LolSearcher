package com.lolsearcher.domain.entity.championstatic.item;
...
public class ChampItemCompKey implements Serializable{
	...
	public ChampItemCompKey() {}

	public ChampItemCompKey(String championId, int seasonId, int itemId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChampItemCompKey other = (ChampItemCompKey) obj;
